...
import PokemonNotFound from "../../assets/not-found.png";

// UI Elements for pokedex
...
export const PokedexOptionsButtons = props => {
  const { enabled, addToFavorites } = props;
  return (
    <>
      <div id="blueButtons1">
      ...
      <div id="yellowBox1" onClick={e => enabled && addToFavorites(e)}>
        Agregar a favoritos
      </div>
...
export const PokedexStats = props => {
  const { stats } = props;
...
export const PokedexScreen = props => {
  ...
  return (
    <>
      <div id="screen">
        ...
        <div id="picture">
          <img
            src={img ? img : PokemonNotFound}
            alt={`${name ? name : "not found"}`}
            height="170"
          />
        </div>
